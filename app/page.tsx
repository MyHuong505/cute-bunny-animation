...
function Home() {
  ...
  const handleHover = (hoverState: boolean) => {
    ...
    if (hoverState === true) {
      ...
      const randomBunnyState = Math.floor(Math.random() * 1);
  ...
  return (
    <StyledHome data-testid="container">
      <div className="home-container">
        {bunnyState === "yes" ? <div className="title">Love ya Baby  !!!!</div> : <div className="title">Will you continue to hug me tight?</div>}
